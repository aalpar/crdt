...
func TestWriteDeltaBatch(t *testing.T) {
	c := qt.New(t)
	...
	c.Run("MissingNotInStore", func(c *qt.C) {
		localCC := dotcontext.New()
		localCC.Add(dotcontext.Dot{ID: "a", Seq: 1})
		localCC.Add(dotcontext.Dot{ID: "a", Seq: 2})
	...
	c.Run("CausalDeltas", func(c *qt.C) {
...
func TestDeltaBatchErrors(t *testing.T) {
	c := qt.New(t)

	c.Run("WriterError", func(c *qt.C) {
		localCC := dotcontext.New()
		localCC.Add(dotcontext.Dot{ID: "a", Seq: 1})
